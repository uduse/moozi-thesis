...
At the last timestep $T$ of any environment, the only legal action will be the dummy action.
The planner still runs a search but will be forced to take the dummy action at the end.
