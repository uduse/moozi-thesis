...
\includeimage[0.6]{experiments_minatar_moozi_vs_ppo}{\textbf{
        Evaluation of \moozi vs PPO in \textit{MinAtar} games, including \textit{Breakout}, \textit{Space Invaders}, \textit{Freeway}, and \textit{Asterix}.}
}{
