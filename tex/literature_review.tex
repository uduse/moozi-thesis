...
\includeimage{mcts}{
    \textbf{The Monte Carlo Tree Search Framework, from \citeauthor{MonteCarloTreeSearch_Chaslot.Bakkes.ea_2008} \cite{MonteCarloTreeSearch_Chaslot.Bakkes.ea_2008}.}
}{}
...
\includeimage[0.9]{muzero_orig}{
    \textbf{Illustration of \textit{MuZero} planning, acting, and training with a learned model.}
}{
    \textit{A}: MuZero plans with MCTS and the learned model.
    The \textit{representation function} $h$ is used to construct the root node.
    The \textit{prediction function} $f$ is used to estimate node values and action priors.
    The \textit{dynamics function} $g$ is used to estimate state transitions and transition rewards.
    \textit{B}: MuZero acts in the environment by sampling an action proportional to the action visit counts at the root.
    \textit{C}: MuZero trains its three functions by aligning the unrolled model outputs and collected statistics in trajectories.
}
...
\includeimage[0.8]{impala}{
    \textbf{IMPALA Architecture, from \citeauthor{IMPALAScalableDistributed_Espeholt.Soyer.ea_2018} \cite{IMPALAScalableDistributed_Espeholt.Soyer.ea_2018}.}.
}{
...
\includeimage[0.8]{seed}{
    \textbf{The SEED Architecture, from \citeauthor{SEEDRLScalable_Espeholt.Marinier.ea_2020} \cite{SEEDRLScalable_Espeholt.Marinier.ea_2020}}.
}{
...
\includeimage[0.5]{acme}{
    \textbf{Example of a distributed asynchronous agent with Acme, from \citeauthor{AcmeResearchFramework_Hoffman.Shahriari.ea_2020} \cite{AcmeResearchFramework_Hoffman.Shahriari.ea_2020}.}
}{}
...
\includeimage[0.5]{rllib}{
    \textbf{RLlib Abstraction Layers, from \citeauthor{RLlibAbstractionsDistributed_Liang.Liaw.ea_2018} \cite{RLlibAbstractionsDistributed_Liang.Liaw.ea_2018}.}
}{}
...
\includeimage{sebulba}{\textbf{Sebulba architecture, from \citeauthor{PodracerArchitecturesScalable_Hessel.Kroiss.ea_2021} \cite{PodracerArchitecturesScalable_Hessel.Kroiss.ea_2021}.}}{
