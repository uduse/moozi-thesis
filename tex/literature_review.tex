...
\includeimage{mcts}{\textbf{The Monte Carlo Tree Search Framework.} Source: \cite{MonteCarloTreeSearch_Chaslot.Bakkes.ea_2008}}
...
\subsubsection{MuZero Reanalyze} \label{sec:muzero_reanalyze}
...
% \subsubsection{Efficiency Problems with ALE} \label{sec:eff_ale}
...
\subsubsection{MinAtar} \label{sec:min_atar}
...
\subsubsection{\Citeauthor{AsynchronousMethodsDeep_Mnih.Badia.ea_2016}'s Asynchronous Methods Framework}
...
\includeimage{impala}{
    ...
    Left: a single learner computes all gradients;
    Right: multiple worker learners compute gradients and one master learner collects and aggregates gradients.
}

\subsubsection{The SEED Architecture}
...
\subsubsection{Ray and RLlib} \label{sec:ray}
...
\subsubsection{JAX and Podracer Architecture} \label{sec:jax_and_podracer}
...
\includeimage{sebulba}{
    \textbf{Sebulba architecture, from \cite{PodracerArchitecturesScalable_Hessel.Kroiss.ea_2021}.}
